...
@section('content')
    <div class="container-fluid p-0">
        <div class="justify-content-center">
            <form action="{{ route('ubahprofile.post') }}" method="post" enctype="multipart/form-data">
                @csrf
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="mb-3">
                            ...
                            <input type="text" name="nama" class="form-control" value="{{ $profile->nama }}" id="exampleInputEmail1" aria-describedby="emailHelp">
                            @error('nama')
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="no_telp" class="form-control" value="{{ $profile->no_telp }}" id="exampleInputPassword1">
                            @error('no_telp')
                                <div class="text-danger">{{ $message }}</div>
                            @enderror
                        </div>
                        <div class="mb-3">
                            ...
                            <input type="text" name="afiliasi" class="form-control" value="{{ $profile->afiliasi }}" id="exampleInputPassword1">
                            @error('afiliasi')
                                <div class="text-danger">{{ $message }}</div>
                            @enderror
                        </div>
