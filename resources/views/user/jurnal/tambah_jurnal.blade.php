...
@section('content')
    <div class="container-fluid p-0">
        <div class="justify-content-center">
            <form action="{{ route('tambahjurnal.post') }}" method="post" enctype="multipart/form-data">
                @csrf
                <div class="card">
                    <div class="card-header">
                        <h5 class="card-title mb-0">Submit Jurnal</h5>
                    </div>
                    <div class="card-body">
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="kata_kunci" class="form-control" id="exampleInputPassword1">
                            @error('kata_kunci')
                                <div class="text-danger">{{ $message }}</div>
                            @enderror
                        </div>
