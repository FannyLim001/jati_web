            ...
            <form action="" method="post" enctype="multipart/form-data">
                ...
                <div class="card">
                    <div class="card-header">
                        <h5 class="card-title mb-0">Akun Reviewer</h5>
                    </div>
                    <div class="card-body">
                        <div class="mb-3">
                            <h2>Username</h2>
                        ...
                        <button type="submit" class="btn btn-primary"><a class="text-white" href="/admin_editreviewer/{{ $user->id }}">Edit Akun</a></button>
                    </div>
                </div>
                <div class="card">
                    <div class="card-header">
                        <h5 class="card-title mb-0">Profil Reviewer</h5>
                    </div>
                    <div class="card-body">
                        ...
                        <button type="submit" class="btn btn-primary"><a class="text-white" href="/admin_edit_profile_reviewer/{{ $user_profile->id }}">Edit Profile</a></button>
                        @else
                        <h2>Data profile belum diisi</h2>
                        <button type="submit" class="btn btn-primary"><a class="text-white" href="/admin_isi_profile_reviewer/{{ $user->id }}">Isi Profile</a></button>
                        @endif
                    </div>
                </div>
            </form>
