        ...
        <div class="col-12">
            <div class="card flex-fill">
                <div class="card-header">
                    <div class="row">
                        <div class="col">
                            <h5 class="card-title mb-0">Daftar Editor</h5>
                        </div>
                        <div class="col d-flex justify-content-end">
                            <button class="btn btn-info">
                                <a class="text-white" href="/admin_tambaheditor">Tambah Editor</a>
                            </button>    
                        </div>
                    </div>
                </div>
                    ...
                    <thead>
                      ...
                      <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <button class="btn btn-info">
                                    <a class="text-white" href="/admin_detaileditor/{{ $j->id }}">
