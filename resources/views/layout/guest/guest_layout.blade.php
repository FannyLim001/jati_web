            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarTogglerDemo01">
                    ...
                    @if (Auth::guard('user')->check())
                        <!-- User is logged in -->
                        <h4 class="user_logged">{{ Auth::user()->username }}</h4>
                        <button class="btn_login" type="submit"><a href="{{ route('logout') }}">Logout</a></button>
                    @elseif (Auth::guard('admin')->check())
                        <h4 class="user_logged">{{ Auth::guard('admin')->user()->username }}</h4>
                        <button class="btn_login" type="submit"><a href="{{ route('logout') }}">Logout</a></button>
                    @else
