        ...
        <nav id="sidebar" class="sidebar js-sidebar">
            <div class="sidebar-content js-simplebar">
                ...
                <ul class="sidebar-nav">
                    ...
                    <li class="sidebar-item {{ Request::path() === 'editor_jurnal' || Request::route()->getName() === 'editordetailjurnal' ? 'active' : '' }}">
                        <a class="sidebar-link" href="/editor_jurnal">
                            <i class="align-middle" data-feather="user"></i> <span class="align-middle">Jurnal</span>
                        </a>
                    </li>
                    @elseif (Auth::user()->role == 'Reviewer')
                    <li class="sidebar-item {{ Request::path() === 'reviewer_jurnal' || Request::route()->getName() === 'reviewerdetailjurnal' ? 'active' : '' }}">
                        <a class="sidebar-link" href="/reviewer_jurnal">
                            <i class="align-middle" data-feather="user"></i> <span class="align-middle">Jurnal</span>
                        </a>
                    </li>
                    @endif
                    ...
                    <li class="sidebar-item {{ Request::path() === 'user_profile' || Request::path() === 'isi_profile' || Request::path() === 'edit_profile' ? 'active' : '' }}">
                        <a class="sidebar-link" href="/user_profile">
